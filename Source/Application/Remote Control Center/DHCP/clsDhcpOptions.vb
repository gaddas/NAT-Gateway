...
Public Class dhcpOptions
    ...
    Public bootFileName As String = String.Empty
    ...
    Public Sub ReadOption(ByVal s As String)
        ...
        Select Case o(0)
            Case "server-name", "domain-name"
                options.Add(o(0), CType(o(1).Replace("""", String.Empty).Trim, String))
            Case "routers", "domain-name-servers", "ntp-servers", "time-servers", "netbios-name-servers"
                ...
                For Each tmpStr As String In tmpText
                    If tmpStr.Trim = String.Empty Then Continue For
                    ...
                    Else
                        ...
                        Catch ex As Sockets.SocketException
                            MessageBox.Show(My.Resources.UnableToResolveAddress & tmpStr, My.Resources.CaptionWarning, MessageBoxButtons.OK, MessageBoxIcon.Error)
                        End Try
    ...
    Public Sub ReadConfig(ByVal s As String)
        ...
        If s.IndexOf("host ") >= 0 Then
            ...
            For Each host As String In hosts
                ' Empty entry
                If host.Trim = String.Empty Then Continue For
        ...
        For Each optionString As String In optionsText
            ...
            If optionString = String.Empty Then Continue For
            ...
            ElseIf o(0) = "filename" Then
                bootFileName = o(1).Replace("""", String.Empty)
            ...
            ElseIf o(0) = "option" Then
                ReadOption(o(1))
            Else
                MessageBox.Show(My.Resources.UnknownToken & o(0), My.Resources.CaptionWarning, MessageBoxButtons.OK, MessageBoxIcon.Warning)
            End If
        Next
