...
Partial Class dhcpd
    ...
    <System.Diagnostics.DebuggerNonUserCode()> _
    Shared Sub Main()
        If (Not System.Diagnostics.EventLog.SourceExists("NetGate DHCP")) Then System.Diagnostics.EventLog.CreateEventSource("NetGate DHCP", "NetGate")
        ...
        '
        ServicesToRun = New System.ServiceProcess.ServiceBase() {New dhcpd}
    ...
    Private Sub InitializeComponent()
        ...
        Me.evLogMain.Source = "NetGate DHCP"
        '
        'dhcpd
        '
        Me.ServiceName = "NetGate DHCP"
